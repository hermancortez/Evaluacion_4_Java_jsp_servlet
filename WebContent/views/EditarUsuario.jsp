...
<body>
	<div class="container">
		...
		<form action="UsuarioDetalleController" method="POST">
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="fecha_nac" name="fecha_nac" placeholder="ingrese fecha de nacimiento" value="${usuario.getFecha_nac()}">
			</div>
			<div class="mb-3">
				<label for="tipo_usuario" class="form-label">Tipo de Usuario</label> 
				<input type="text" class="form-control" id="tipo_usuario" name="tipo_usuario" placeholder="seleccione el tipo de usuario" value="${usuario.getTipo_usuario()}">
			</div>			
			 <div class="col-12">
    			
    			<a class="nav-link active" href="UsuarioController"><button type="submit" class="btn btn-primary">Editar</button></a>
  			</div>
		</form>
	</div>
</body>
