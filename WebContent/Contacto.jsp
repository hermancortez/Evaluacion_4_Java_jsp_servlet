        ...
        <form method="post" action="Contacto" id="formulario">
          ...
          <div class="campo">
            <div class="en-linea izquierdo">
              <label for="email">Correo electrónico:</label> <input type="email" id="email" name="correo" required />
            </div>

            <div class="en linea">
              <label for="telefono">Teléfono:</label> <input type="number" id="telefono" name="telefono" required />
            </div>
          </div>
